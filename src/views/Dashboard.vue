<template>
  <div>
    <b-row>
      <b-col md="3" sm="6"><StatusCard label="Server" value="Online" tone="ok" detail="FastAPI reachable" /></b-col>
      <b-col md="3" sm="6"><StatusCard label="MQTT" :value="mqttState" :tone="mqttTone" detail="Broker bridge" /></b-col>
      <b-col md="3" sm="6"><StatusCard label="Motion" :value="motionState" detail="Controller status" /></b-col>
      <b-col md="3" sm="6"><StatusCard label="Camera" :value="cameraState" detail="Pi camera devices" /></b-col>
      <b-col md="3" sm="6"><StatusCard label="Total Tanks" :value="tanks.length" detail="Registered tanks" /></b-col>
      <b-col md="3" sm="6"><StatusCard label="Need Harvest" :value="harvestReady" tone="warn" detail="Soft-shell status" /></b-col>
      <b-col md="3" sm="6"><StatusCard label="Current Scan" :value="currentScan" detail="Latest scan job" /></b-col>
      <b-col md="3" sm="6"><StatusCard label="Last Detection" :value="lastDetection" detail="Detection pipeline" /></b-col>
    </b-row>
      ...
      <b-col lg="6">
        <div class="panel">
          ...
          <div class="panel-body">
            <DataTable :items="detections.slice(0, 6)" :fields="detectionFields" />
          </div>
        </div>
      </b-col>
      <b-col lg="6">
...
export default {
  ...
  computed: {
    mqttState() { return this.health && this.health.mqtt_connected ? 'Connected' : 'Unknown' },
    mqttTone() { return this.health && this.health.mqtt_connected ? 'ok' : 'warn' },
    motionState() {
