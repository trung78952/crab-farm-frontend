    ...
    <div class="panel-body">
      <b-row>
        <b-col md="6">
          ...
          <b-form-checkbox :checked="$store.state.darkMode" switch @change="$store.commit('setDarkMode', $event)">
            Dark mode
          </b-form-checkbox>
          <hr>
        ...
        <b-col md="6">
          <div class="console-panel">Frontend: Vue 2.6.12
Auth: JWT Bearer
Theme: Fluidd-inspired dark console
Simulation: {{ aiStatus.simulation_mode }}
AI enabled: {{ aiStatus.enabled }}
AI mock: {{ aiStatus.mock_mode }}
Model: {{ aiStatus.active_model_version }}</div>
          <hr>
